...
class VistaPantallas {
    ...
    void dibujarJuego(int ancho, int largo, Mapa& juego, VistaMapa vista, Texture2D torreArq, Texture2D torreMago, Texture2D torreArtillero, Texture2D puerta, Texture2D puente) ;
